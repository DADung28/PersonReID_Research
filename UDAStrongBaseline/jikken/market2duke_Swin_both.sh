...
python3 sbs_traindbscan.py -tt dukemtmc --height 224 --width 224  --lr 0.001 -st market1501 -a Swin --train_type source+target\
	--num-instances 4 --iters 400 -b 32 --epochs 200 --eval-step 4\
	--dropout 0 --n-jobs 16 --choice_c 0 \
	--init-1 logs/market1501TOdukemtmc/Swin/model_best.pth.tar \
	--logs-dir logs/dbscan-market1501TOdukemtmc/Swin_both_0.001_ce_tri

python3 sbs_traindbscan.py -tt dukemtmc --height 224 --width 224  --lr 0.001 -st market1501 -a Swin --train_type source+target_tri\
	--num-instances 4 --iters 400 -b 32 --epochs 200 --eval-step 4\
	--dropout 0 --n-jobs 16 --choice_c 0 \
	--init-1 logs/market1501TOdukemtmc/Swin/model_best.pth.tar \
	--logs-dir logs/dbscan-market1501TOdukemtmc/Swin_both_0.001_targetCe_tri
# DBSCAN uncertantly

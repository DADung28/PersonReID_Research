...
python3 source_pretrain.py -train market1501_stargan_randomcam -ds market1501 --height 256 --width 128 -dt dukemtmc -a ResNet50 --adam --seed 0 --margin 0.0 \
	--num-instances 16 -b 64 -j 4 --warmup-step 10 --lr 0.00035 --milestones 40 70 --iters 200 --epochs 100 \
	--eval-step 10 --logs-dir logs/jikken/market2duke/ResNet_stargan_randomcam_200_0.00035

python3 source_pretrain.py -train dukemtmc_stargan_random -ds dukemtmc --height 256 --width 128 -dt market1501 -a ResNet50 --adam --seed 0 --margin 0.0 \
	--num-instances 16 -b 64 -j 4 --warmup-step 10 --lr 0.00035 --milestones 40 70 --iters 200 --epochs 100 \
	--eval-step 10 --logs-dir logs/jikken/duke2market/ResNet_stargan_randomcam_200_0.00035

...
class ViT(nn.Module):
    def __init__(self, class_num=751, droprate=0.5, linear_num=512, size=384):
        super().__init__()
        ...
        self.classifier = ClassBlock(768, class_num, droprate, linear=linear_num)
    def forward(self, x):
...
class Swin(nn.Module):
    def __init__(self, class_num=751, droprate=0.5, linear_num=512, size=384):
        ...
        self.classifier = ClassBlock(1024, class_num, droprate, linear=linear_num)
    def forward(self, x):

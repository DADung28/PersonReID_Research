...
python3 source_pretrain.py -train dukemtmc -dt market1501  --height 256 --width 128 -ds dukemtmc -a ResNet50 --adam --seed 0 --margin 0.0 --iters 0\
   --num-instances 0 -b 64 -j 4 --warmup-step 10 --lr 0.00035 --milestones 40 70 --epochs 200 \
	--eval-step 10 --logs-dir logs/final_expr/duke2market/ResNet50_2

python3 source_pretrain.py -train market1501 -dt dukemtmc  --height 256 --width 128 -ds market1501 -a ResNet50 --adam --seed 0 --margin 0.0 --iters 0\
   --num-instances 0 -b 64 -j 4 --warmup-step 10 --lr 0.00035 --milestones 40 70 --epochs 200 \
	--eval-step 10 --logs-dir logs/final_expr/market2duke/ResNet50_2

python3 source_pretrain.py -train dukemtmc -dt market1501  --height 256 --width 128 -ds dukemtmc -a ResNet50 --adam --seed 0 --margin 0.0 --iters 0\
   --num-instances 0 -b 64 -j 4 --warmup-step 10 --lr 0.00035 --milestones 40 70 --epochs 200 \
	--eval-step 10 --logs-dir logs/final_expr/duke2market/ResNet50_3

python3 source_pretrain.py -train market1501 -dt dukemtmc  --height 256 --width 128 -ds market1501 -a ResNet50 --adam --seed 0 --margin 0.0 --iters 0\
   --num-instances 0 -b 64 -j 4 --warmup-step 10 --lr 0.00035 --milestones 40 70 --epochs 200 \
	--eval-step 10 --logs-dir logs/final_expr/market2duke/ResNet50_3
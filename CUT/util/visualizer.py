...
class Visualizer():
    ...
    def print_current_losses(self, epoch, current_iters, iters, losses, t_comp, t_data):
        ...
        """
        message = '(epoch: %d, iters: %d/%d, time: %.3f, data: %.3f) ' % (epoch, current_iters, iters, t_comp, t_data)

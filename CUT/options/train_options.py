...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--image_save_dir', type=str, default='./sample_images/cut_segemetation', help='resume training from another checkpoint')
        # training parameters
        ...
        parser.add_argument('--iters', type=int, default=3000, help='number of epochs to linearly decay learning rate to zero')

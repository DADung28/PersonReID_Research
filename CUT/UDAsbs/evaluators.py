...
class Evaluator(object):
    ...
    def evaluate(self, data_loader, query, gallery, metric=None, cmc_flag=False, rerank=False, pre_features=None):
        ...
        return evaluate_all(query_features, gallery_features, distmat_rerank, query=query, gallery=gallery, cmc_flag=cmc_flag), evaluate_all(query_features, gallery_features, distmat, query=query, gallery=gallery, cmc_flag=cmc_flag) 

...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self, config, **kwargs):
        ...
        self.ocr_gather_head = SpatialGather_Module(config.MODEL.NUM_CLASSES)
        ...
        self.cls_head = nn.Conv2d(
            ocr_mid_channels, config.MODEL.NUM_CLASSES, kernel_size=1, stride=1, padding=0, bias=True)
        ...
        self.aux_head = nn.Sequential(
            ...
            nn.ReLU(inplace=relu_inplace),
            nn.Conv2d(last_inp_channels, config.MODEL.NUM_CLASSES,

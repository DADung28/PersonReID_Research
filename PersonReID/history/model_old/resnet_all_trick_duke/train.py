...
from model import ft_net, ft_net_dense, ft_net_hr, ft_net_swin, ft_net_swinv2, ft_net_convnext, ft_net_efficient, ft_net_NAS, PCB, ViTReID, ViTReIDRaw
...
# data
parser.add_argument('--data_dir',default='/home/jun/ReID_Dataset/market1501/dataloader',type=str, help='training dir path')

...
from model import ft_net, ft_net_dense, ft_net_hr, ft_net_swin, ft_net_swinv2, ft_net_efficient, ft_net_NAS, ft_net_convnext, PCB, PCB_test, ViTReID, ViTReIDRaw, LATransformerTest
...
if opt.use_dense:
    ...
    model_structure = LATransformerTest(opt.nclasses)
elif opt.use_vit:
    model_structure = ViTReID(opt.nclasses, linear_num=opt.linear_num)
elif opt.use_vitraw:
    model_structure = ViTReIDRaw(opt.nclasses, linear_num=opt.linear_num)
else:

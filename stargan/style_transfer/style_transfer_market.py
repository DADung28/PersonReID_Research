...
for name in list:
    ...
    #solver.G.load_state_dict(torch.load(f'/home/jun/stargan/checkpoints/personreid_parsing_singlecam/models/200000-G.ckpt'))
    solver.G.to(solver.device)
    
    #new_dataset_parrent_dir = Path(f'/home/jun/ReID_Dataset/Market-1501-v15.09.15-stargan-{name}')
    new_dataset_parrent_dir = Path(f'/home/jun/ReID_Dataset/Market-1501-v15.09.15-starspgan-{name}')
    #new_dataset_parrent_dir = Path(f'/home/jun/ReID_Dataset/Market-1501-v15.09.15-starspgan-singlecam_0_0')
    new_dataset_parrent_dir.mkdir(exist_ok=True)
    for i in range(cam_num):
        new_data_dir_market1501 = new_dataset_parrent_dir/ f'Market-1501-v15.09.15-stargan-cam{i}'
